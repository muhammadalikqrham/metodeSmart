              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><?= $no + 1 ?></td>
                    <td><?= $row['nama_alternatif'] ?></td>
                    <td><?= (float)$normPh_tanah[$no] * (float)$bobotAlt[0]['nilai_bobot'] ?></td>
                    <td><?= (float) $normTeksturTanah[$no] * (float)$bobotAlt[1]['nilai_bobot']; ?></td>
                    <td><?= (float) $normUsia[$no] * (float)$bobotAlt[2]['nilai_bobot']; ?></td>
                    <td><?= (float) $normBatang[$no] * (float)$bobotAlt[3]['nilai_bobot']; ?></td>
                    <td><?= (float) $normPupuk[$no] * (float)$bobotAlt[4]['nilai_bobot']; ?></td>
                  </tr>
                <?php $no++;
                endforeach; ?>
              </tbody>
                  ...
                  ?>
                    <tr>
                      <?php if ($row[1] == ($i + 1)) : ?>
                        ...
                        <td><?= (float) $normTeksturTanah[$i] * (float)$bobotAlt[1]['nilai_bobot']; ?></td>
                        <td><?= (float) $normUsia[$i] * (float)$bobotAlt[2]['nilai_bobot']; ?></td>
                        <td><?= (float) $normBatang[$i] * (float)$bobotAlt[3]['nilai_bobot']; ?></td>
                        <td><?= (float) $normPupuk[$i] * (float)$bobotAlt[4]['nilai_bobot']; ?></td>
                        <td><?= $row[0]; ?></td>
                        <td><?= $row[1];  ?></td>
                      <?php endif; ?>
                    </tr>
